  ...
  return (
    <>
      ...
      <div id="Contact" className="contact mt-32 sm:p-10 p-0">
        ...
        <form action="https://formsubmit.co/patrasawali93@." method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" autoComplete="off">
